...
// MODIFIED: 05/28/2013 (Joel Serbinski): This code causes bug with jQuery 1.8.0
// ALL INPUT events...

// NOTE: we DO NOT USE the blur event, issues
...
//  MODIFIED:
// :: removed because even click/holding on the popup would close it (essentially interpreting as clicking outside of the popup maybe?)
// :: the FOCUS event ...
//
//	    //---------------------------------------------------------------------
...
// MODIFIED: 
// ####!!!!! DISABLED 2012/07/19 because users hate this behavior!
//
//	        div.dblclick(
//				function (e) {
//				    var elem = $(this);
...
//				});
	    ...
	    cleanup: function (event) {
            // MODIFIED: we DO NOT USE the blur event, issues
