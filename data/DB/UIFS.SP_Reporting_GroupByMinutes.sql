...
BEGIN
	...
	SELECT dbo.DateTime_Bucket([submittedon],@IntervalMinutes), COUNT(*)
	FROM [Form] GROUP BY dbo.DateTime_Bucket(submittedon,@IntervalMinutes)
	ORDER BY dbo.DateTime_Bucket([submittedon],@IntervalMinutes) desc
